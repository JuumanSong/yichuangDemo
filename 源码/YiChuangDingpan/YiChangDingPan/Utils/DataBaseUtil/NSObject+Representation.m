...
- (id)decodeValue:(id)value collectionClass:(id)classes propertyName:(NSString *)name {
    ...
    if (cls == Nil) {
        ...
        NSArray *array = [classes subarrayWithRange:NSMakeRange(1, [(NSArray *)classes count] - 1)];
        return [self decodeValue:value collectionClass:array propertyName:name];
    } else if ([value isKindOfClass:[NSArray class]]) {
        NSMutableArray *dstCollection = [NSMutableArray arrayWithCapacity:[(NSArray *)value count]];
        ...
        NSMutableDictionary *dstCollection = [NSMutableDictionary dictionaryWithCapacity:[(NSDictionary *)value count]];
        NSArray *array = [classes subarrayWithRange:NSMakeRange(1, [(NSArray *)classes count] - 1)];
